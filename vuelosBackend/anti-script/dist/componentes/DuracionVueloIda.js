...
export default async function DuracionVueloIda({ page, horaDeseada, }) {
    var _a, _b;
    ...
    if (!boxVueloIda)
        throw new Error("No se pudo encontrar el slider de duración de vuelo");
    ...
    const horaMinimaTextTrimmed = (_a = horaMinimaText === null || horaMinimaText === void 0 ? void 0 : horaMinimaText.split("hs")[0]) === null || _a === void 0 ? void 0 : _a.trim();
    const horamaximaTextTrimmed = (_b = horamaximaText === null || horamaximaText === void 0 ? void 0 : horamaximaText.split("hs")[0]) === null || _b === void 0 ? void 0 : _b.trim();
    if (typeof horaMinimaTextTrimmed !== 'string' ||
    ...
    if (!boxHandleDerecho)
        throw new Error("No se pudo obtener el handle derecho");
